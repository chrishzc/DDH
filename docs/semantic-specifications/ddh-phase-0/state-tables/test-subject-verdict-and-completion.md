...
- Task Specification: `DDH-P0-SPEC-001` version `1.1.0`
...
| Fixture points to the wrong manifest entry while specification uniquely identifies the correct entry | `test_implementation_defect` | Propose new fixture/asset version and repeat independent admission | Treat repaired draft diagnostic PASS as formal PASS |
